...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("chick.wav"));
		...
		showScaryImage("scarycat.jpg");
	}

	private void showScaryImage(String noImage) {
		try {
			maze = ImageIO.read(getClass().getResource(noImage));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + noImage);
		}
		repaint();
	}
